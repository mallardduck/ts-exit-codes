...
export class ExitCodeDescriptions {
    public exitCodeDescriptionMap = {
    ...
    public static create(): ExitCodeDescriptions
    {
        return new ExitCodeDescriptions()
    }

    public getDescription(exitCode: AnyExitCode): string
    {
        let exitCodeInt: number = +exitCode;
